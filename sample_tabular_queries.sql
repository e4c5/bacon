...
-- A) Movies Kevin Bacon (id=102, birth=1958) acted in
SELECT *
FROM cypher('bacon', $$
...
-- C) Degree of separation between Robert Redford and Kevin Bacon
...
-- One concrete 2-hop bridge (example evidence)
